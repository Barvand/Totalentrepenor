    ...
    <>
      <section className="mt-5 container grid gap-4 text-center sm:grid-cols-1 lg:grid-cols-2">
        <div className="bg-secondary p-4 box-shadow">
          <h1 className="mb-4 text-2xl font-bold leading-none tracking-tight text-primary md:text-5xl lg:text-6xl dark:text-white">
            Vi opererer i Bergen og område
          </h1>
          <button className="btn bg-primary text-white">Snakk med oss</button>
        </div>
